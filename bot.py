...
def api_check_sub(telegram_id: str) -> dict:
    ...
    try:
        ...
        return {"linked": False, "has_sub": False, "plan": "Free",
                ...
                "register_url": "https://ais-dev-od4aemezdgaeup2ncw76si-295455119343.europe-west2.run.appauth.html"}
...
LINK_URL = "https://ais-dev-od4aemezdgaeup2ncw76si-295455119343.europe-west2.run.appauth.html"
...
async def link_account_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if sub.get("linked"):
        ...
        if lang == "ar":
            msg = f"✅ *حسابك مرتبط*\n\n📧 البريد: {email}\n💳 الخطة: {plan}\n\n[🌐 فتح لوحة التحكم](https://ais-dev-od4aemezdgaeup2ncw76si-295455119343.europe-west2.run.appdashboard.html)"
        else:
            msg = f"✅ *Account Linked*\n\n📧 Email: {email}\n💳 Plan: {plan}\n\n[🌐 Open Dashboard](https://ais-dev-od4aemezdgaeup2ncw76si-295455119343.europe-west2.run.appdashboard.html)"
    else:
        if lang == "ar":
    ...
    keyboard = [[InlineKeyboardButton(
        ...
        url="https://ais-dev-od4aemezdgaeup2ncw76si-295455119343.europe-west2.run.appauth.html"
    )]]
...
async def upgrade_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [[InlineKeyboardButton(
        ...
        url="https://ais-dev-od4aemezdgaeup2ncw76si-295455119343.europe-west2.run.apppricing.html"
    )]]
