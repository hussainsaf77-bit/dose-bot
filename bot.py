...
def api_check_sub(telegram_id: str) -> dict:
    ...
    try:
        ...
        return {"linked": False, "has_sub": False, "plan": "Free",
                ...
                "register_url": "https://dose-web-api.onrender.com"}
...
LINK_URL = "https://dose-web-api.onrender.com"
...
def kb_lang():
    return InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("🌐 فتح تطبيق وموقع جرعة الطبي | Web App", url="https://dose-web-api.onrender.com")
        ]
    ])
...
def kb_main(lang):
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🌐 " + ("فتح تطبيق الويب" if lang=="ar" else "Open Web App"), url="https://dose-web-api.onrender.com")]])
...
PADDLE_CHECKOUT = "https://dose-web-api.onrender.com"
...
async def link_account_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if sub.get("linked"):
        ...
        if lang == "ar":
            msg = f"✅ *حسابك مرتبط*\n\n📧 البريد: {email}\n💳 الخطة: {plan}\n\n[🌐 فتح لوحة التحكم](https://dose-web-api.onrender.com"
        else:
            msg = f"✅ *Account Linked*\n\n📧 Email: {email}\n💳 Plan: {plan}\n\n[🌐 Open Dashboard](https://dose-web-api.onrender.com"
    else:
        if lang == "ar":
    ...
    keyboard = [[InlineKeyboardButton(
        ...
        url="https://dose-web-api.onrender.com"
    )]]
