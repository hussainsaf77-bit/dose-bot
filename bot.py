            ...
            r = await c.post("https://api.anthropic.com/v1/messages",
                ...
                json={"model": "claude-haiku-4-5-20251001", "max_tokens": 200,
                    "messages": [{"role": "user", "content": [
                        ...
                        {"type": "text", "text": "You are a pharmacist. Carefully read ALL text on this medicine packaging. Step 1: Find the generic/active ingredient. Brand mappings: Panadol/Calpol/Tylenol=paracetamol, Nurofen/Brufen/Advil=ibuprofen, Claritin/Claritine=loratadine, Glucophage=metformin, Scobinal/Buscopan=hyoscine_butylbromide, Anazol/Flagyl=metronidazole, Zithromax=azithromycin, Amoxil=amoxicillin, Augmentin=amoxicillin_clavulanate, Zyrtec=cetirizine, Ventolin=salbutamol. Step 2: Find the EXACT concentration - look for patterns like: 120mg/5ml, 250mg/5ml, 100mg/5ml, 500mg, 200mg, 400mg/5ml, 125mg/5ml. For paracetamol syrups the common concentrations are 120mg/5ml (infant) or 250mg/5ml (child). For ibuprofen syrups: 100mg/5ml. Look very carefully at all numbers on the packaging. Return ONLY: GENERIC_NAME|CONCENTRATION. Examples: paracetamol|120mg/5ml, ibuprofen|100mg/5ml, metformin|500mg. If concentration truly not visible: GENERIC_NAME|unknown."}
                    ]}]})
