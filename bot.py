...
def kb_main(lang):
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🌐 " + ("تطبيق الويب" if lang=="ar" else "Web App"), url="https://hussainsaf77-bit.github.io/Dose-web/#tab-waitlist")]])
...
PADDLE_CHECKOUT = "https://hussainsaf77-bit.github.io/Dose-web/#tab-waitlist"
